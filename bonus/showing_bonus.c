...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/01/29 16:24:07 by oryadi            #+#    #+#             */
/*   Updated: 2023/02/04 21:56:59 by oryadi           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_conditshow(t_all *all, size_t x, size_t y)
{
	if (all->component.map[y][x] == 'C')
		draw_tile(all, x, y, "./textures/hearts_xpm/blue_heart.xpm");
	else if (all->component.map[y][x] == 'R')
		draw_tile(all, x, y, "bonus/textures_bonus/papyrusright.xpm");
}

void	showingall(t_all *all, size_t x, size_t y)
{
	mlx_string_put(all->mlx.mlx, all->mlx.mlx_win, 10, 10, 0x000000FF, "0");
